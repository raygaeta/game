import {
  ...
  sg,
  wI
} from "./chunk-ISCSL76F.js";
import {
  mergeVertices
} from "./chunk-7YH435WV.js";
import {
  suspend,
  useFrame,
  useThree
} from "./chunk-5GMLIQDG.js";
import {
  BufferAttribute,
  DynamicDrawUsage,
  Euler,
...
// node_modules/.pnpm/@react-three+rapier@1.5.0_@react-three+fiber@8.17.10_@types+react@19.0.2_react-dom@18.3.1_rea_7wpj7fkmn4wp3xjqrxsqgkprci/node_modules/@react-three/rapier/dist/react-three-rapier.esm.js
...
var importRapier = async () => {
  let r = await import("./rapier.es-XHC5GWNJ.js");
  await r.init();
  return r;
};
var Physics = (props) => {
